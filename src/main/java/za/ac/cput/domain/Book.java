...
public class Book {
    ...
    public Book(String title, String author, String isbn) {
        if (isbn == null || isbn.isEmpty()) {
            throw new IllegalArgumentException("ISBN number cannot be null or empty.");
        }
        if (title == null || title.isEmpty()) {
            throw new NullPointerException("Title cannot be null or empty.");
        }
        if (author == null || author.isEmpty()) {
            throw new NullPointerException("Author cannot be null or empty.");
        }
        this.title = title;
        this.author = author;
        this.isbn = isbn;
